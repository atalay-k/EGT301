...
- Sınırlandırılmış performans görevleri
...
- Performans görevi hazırlanırken **iki yöntem** izlenebilir. 

- Bunlardan ilki ölçülmek istenilen **üst düzey zihinsel süreç ya da süreçlerin belirlenmesi**, **ders içeriği ile ilişkilendirilmesi** ve performans görevinin yazılmasıdır. 
...
- O’Malley ve Valdez’de  (1997)belirtilen üçlü portfolyo sınıflaması aşağıdaki gibidir:
...
- Derleme portfolyoda öğrencinin ürünleri içerisinden öğretmenin rehberliği ile seçtiği çalışmaları içerir. 

- Toplanan ürünler öğrenci hakkında karar vermeyi içermekten çok karar vermeye hazırlayıcı süreçlerdir.
...
- Uyarlama yapmak istiyorsanız uyarlama yapacağınız aracın hedeflenen performansa uygun olup olmadığına karar verin. Uzman görüşü alın. http://intranet.cps.k12.il.us
