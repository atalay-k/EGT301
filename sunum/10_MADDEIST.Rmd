---
title: "EGİTİMDE ÖLÇME VE DEĞERLENDİRME"
...
-   Çok kolay ya da çok zor sorular sınıftaki öğrencileri **ayırt etmede yetersiz olabilirler.**
...
$$
 p = \frac{maddeye  \quad doğru  \quad cevap  \quad verenler}{tüm  \quad cevaplayıcılar}
$$
...
$p_{15}=\frac{200}{200}=1,00$ olarak bulunur.
...
$p_{20}=\frac{10}{200}=0,05$ olarak bulunur. olarak bulunur. Sizce bu soru nasıldır?
...
$p_{25}=\frac{100}{200}=0,50$ olarak bulunur. olarak bulunur.
...
- Madde güçlüğünün orta değeri 0.50'dir. Bu değer maddenin orta güçlükte (zorlukta) olduğunun göstergesidir. 
...
$p_{j} =\frac{üst \quad grupta \quad - \quad alt\quad grupta \quad dogru\quad cevaplayan \quad öğrenci \quad sayısı}{(toplam \quad öğrenci \quad sayısı)/2}$

$p_{j} =\frac{üst \quad grupta \quad - \quad alt\quad grupta \quad dogru\quad cevaplayan \quad öğrenci \quad sayısı}{ust\quad gruptaki \quad öğrenci\quad sayısı}$
